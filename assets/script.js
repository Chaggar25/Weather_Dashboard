...
function searchWeather(cityName) {
    ...
    var apiurl = "https://api.openweathermap.org/data/2.5/weather?q=" + cityName + "&units=imperial&appid=3ee8b3503a0dd26bd03708962f05d234"; 
    fetch(apiurl)
    ...
    var apiurl = "https://api.openweathermap.org/data/2.5/forecast?q=" + cityName + "&units=imperial&appid=3ee8b3503a0dd26bd03708962f05d234";
    fetch(apiurl)
        .then(function (response) {
            return response.json()
        })
